package com.example.phonebook.ui.theme.component
...
import com.example.phonebook.ui.theme.MyPhoneSettings
...
//        )
//        Switch(
//            checked = MyPhoneSettings.isDarkThemeEnabled,
//            onCheckedChange = { MyPhoneSettings.isDarkThemeEnabled = it },
//            modifier = Modifier
...
fun AppDrawer(
    ...
    Column(modifier = Modifier.fillMaxSize()) {
        ...
        ScreenNavigationButton(
            ...
            onClick = {
                MyPhoneRouter.navigateTo(Screen.Trash)
                closeDrawerAction()
            }
        )
        LightDarkThemeItem()
